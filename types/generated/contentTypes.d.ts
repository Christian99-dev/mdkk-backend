...
export interface ApiAboutMeAboutMe extends Schema.SingleType {
  ...
  attributes: {
    ...
    Lebenslauf: Attribute.Component<'all.text', true> &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 1;
      }>;
...
export interface ApiArbeitArbeit extends Schema.SingleType {
  collectionName: 'arbeits';
  info: {
    singularName: 'arbeit';
    pluralName: 'arbeits';
    displayName: 'Arbeit';
  ...
  attributes: {
    ...
    Taetigkeiten: Attribute.Component<'all.arbeitskarte', true> &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 3;
      }>;
...
export interface ApiSeoSeo extends Schema.SingleType {
  ...
  attributes: {
    ...
    Homepage: Attribute.Component<'all.seo-page-info'> & Attribute.Required;
    Impressum: Attribute.Component<'all.seo-page-info'> & Attribute.Required;
    Agb: Attribute.Component<'all.seo-page-info'> & Attribute.Required;
    Datenschutzerklaerung: Attribute.Component<'all.seo-page-info'> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::arbeit.arbeit': ApiArbeitArbeit;
